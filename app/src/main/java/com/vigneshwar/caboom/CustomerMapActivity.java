...
public class CustomerMapActivity extends FragmentActivity implements OnMapReadyCallback {
        ...
        mRequest.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (requestBol){
                    ...
                    mRequest.setText("Getting your nearest Mechanic....");
    ...
    private void getClosestMechanic(){
        DatabaseReference driverLocation = FirebaseDatabase.getInstance().getReference().child("mechanicsAvailable");
    ...
    *-------------------------------------------------------------------*/
    ...
    private void getHasRideEnded(){
        serviceHasEndedRef = FirebaseDatabase.getInstance().getReference().child("Users").child("Mechanics").child(mechanicFoundID).child("customerRequest").child("customerRideId");
